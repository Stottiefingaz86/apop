...
// Polymorphic column items; consumers use typed hooks at call sites.
// eslint-disable-next-line @typescript-eslint/no-explicit-any -- context holds generic T from Kanban root
  ...
  return (
    <SortableContext items={columnIds} strategy={rectSortingStrategy}>
      <Comp
        ...
        className={cn(
          /* Horizontal lanes by default; consumers can pass `grid grid-cols-*` to override */
          "flex w-max flex-row flex-nowrap items-stretch gap-4",
          className,
        )}
        {...props}
      >
